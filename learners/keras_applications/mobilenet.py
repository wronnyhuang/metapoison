...
def MobileNet(input_shape=None,
    ...
    x = _depthwise_conv_block(x, 1024, alpha, depth_multiplier,
                              strides=(2, 2), block_id=12, params=params)
    ...
    if include_top:
        ...
        x = layers.Conv2D(classes, (1, 1),
                          padding='same',
                          name='conv_preds')(x, params=params)
...
def _conv_block(inputs, filters, alpha, kernel=(3, 3), strides=(1, 1), params=PARAM_NONE):
    ...
    x = layers.BatchNormalization(axis=channel_axis, name='conv1_bn')(x, params=params)
    return layers.ReLU(6., name='conv1_relu')(x)


def _depthwise_conv_block(inputs, pointwise_conv_filters, alpha,
                          depth_multiplier=1, strides=(1, 1), block_id=1, params=PARAM_NONE):
    ...
    x = layers.DepthwiseConv2D((3, 3),
                               ...
                               strides=strides,
                               use_bias=False,
                               name='conv_dw_%d' % block_id)(x, params=params)
    x = layers.BatchNormalization(
        axis=channel_axis, name='conv_dw_%d_bn' % block_id)(x, params=params)
    ...
    x = layers.Conv2D(pointwise_conv_filters, (1, 1),
                      ...
                      use_bias=False,
                      strides=(1, 1),
                      name='conv_pw_%d' % block_id)(x, params=params)
    x = layers.BatchNormalization(axis=channel_axis,
                                  name='conv_pw_%d_bn' % block_id)(x, params=params)
